            ...
            <table>
              <tbody>
                <tr className="row1">
                  ...
                  <td><img id="phoneReceiver" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Telephone_receiver.svg/1920px-Telephone_receiver.svg.png" /></td>
...
Supporting over 50 sustainable travel projects
                  ...
                  <td className="row2part2" id="brands">
                    ...
                    <div className="brandsDropdown">
                      <table>
                        <tbody>
                          <tr>
                            <td><img className="brandsDropdownImg" src="https://searchlogovector.com/wp-content/uploads/2018/12/brendan-vacations-logo-vector.png" /></td>
                            <td><img className="brandsDrowdownImg" src="https://www.costsavertour.com/-/media/Project/Costsaver/costsaver-logo.png" /></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <td className="row2part2img">
                    {' '}
                    <img id="userAvatar" src="https://huntpng.com/images250/avatar-pic-circle-png-10.png" />
                    <span>
My Trafalgar
                      <i className="downArrow" />
                    </span>
