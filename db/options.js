...
const continents = ['Africa', 'Asia', 'Europe', 'North_America', 'South_America', 'South_Pacific'];

const countries = {
  Africa: ['Egypt', 'Kenya', 'Morocco', 'South_Africa'],
  Asia: ['China', 'Israel', 'India', 'Japan', 'South_Korea', 'Thailand', 'Vietnam'],
  Europe: ['France', 'Germany', 'Greece', 'Ireland', 'Italy', 'Netherlands', 'Norway', 'Poland', 'Portugal', 'Russia', 'Spain', 'Switzerland', 'United_Kingdom'],
  North_America: ['United_States', 'Costa_Rica', 'Mexico', 'Canada'],
  South_America: ['Brazil', 'Peru'],
  South_Pacific: ['Australia', 'New_Zealand'],
};

const cities = {
  Egypt: ['Cairo', 'Alexandria', 'Luxor', 'Aswan', 'Giza', 'Nubia'],
  Kenya: ['Nairobi', 'Nakuru'],
  Morocoo: ['Casablanca', 'Fez', 'Marrakech', 'Tinghir'],
  ...
  United_States: ['Juneau', 'Anchorage', 'Fairbanks', 'Seward'],
